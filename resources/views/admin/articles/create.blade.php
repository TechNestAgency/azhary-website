...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Articles /</span> Create Article
    </h4>
                    ...
                    <form action="{{ route('admin.articles.store') }}" method="POST" enctype="multipart/form-data" id="articleForm">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('title.en') is-invalid @enderror" 
                                id="title_en" name="title[en]" value="{{ old('title.en') }}" required />
                            @error('title.en')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('title.fr') is-invalid @enderror" 
                                id="title_fr" name="title[fr]" value="{{ old('title.fr') }}" required />
                            @error('title.fr')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('content.en') is-invalid @enderror" 
                                id="content_en" name="content[en]" rows="5">{{ old('content.en') }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('content.fr') is-invalid @enderror" 
                                id="content_fr" name="content[fr]" rows="5">{{ old('content.fr') }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('meta_description.en') is-invalid @enderror" 
                                id="meta_description_en" name="meta_description[en]" rows="2">{{ old('meta_description.en') }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('meta_description.fr') is-invalid @enderror" 
                                id="meta_description_fr" name="meta_description[fr]" rows="2">{{ old('meta_description.fr') }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('meta_keywords.en') is-invalid @enderror" 
                                id="meta_keywords_en" name="meta_keywords[en]" value="{{ old('meta_keywords.en') }}" />
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('meta_keywords.fr') is-invalid @enderror" 
                                id="meta_keywords_fr" name="meta_keywords[fr]" value="{{ old('meta_keywords.fr') }}" />
