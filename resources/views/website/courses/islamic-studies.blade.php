...
@section('title', __('website.Islamic Studies') . ' - Azhary Academy')
@section('meta_description', __('website.Explore the fundamentals of Islam including Aqeedah, Fiqh, and Seerah'))
...
<div class="course-page">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-8">
                    <div class="course-content">
                        ...
                        <p class="lead">{{ __('website.islamic_studies_description') }}</p>
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="level1" class="accordion-collapse collapse show" data-bs-parent="#courseAccordion">
                                        <div class="accordion-body">
                                            <p>{{ __('website.islamic_studies_level1_desc') }}</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    ...
                                    <div id="level2" class="accordion-collapse collapse" data-bs-parent="#courseAccordion">
                                        <div class="accordion-body">
                                            <p>{{ __('website.islamic_studies_level2_desc') }}</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    ...
                                    <div id="level3" class="accordion-collapse collapse" data-bs-parent="#courseAccordion">
                                        <div class="accordion-body">
                                            <p>{{ __('website.islamic_studies_level3_desc') }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body p-4">
                                ...
                                <ul class="list-unstyled">
                                    <li class="mb-3">
                                        ...
                                        <strong>{{ __('website.Duration') }}:</strong> 1-2 years
                                    </li>
                                    <li class="mb-3">
                                        <i class="bi bi-person text-primary me-2"></i>
                                        <strong>{{ __('website.Level') }}:</strong> {{ __('website.All levels') }}
                                    </li>
                                    <li class="mb-3">
                ...
                <div class="col-md-6">
                    <div class="testimonial-card p-4 bg-white rounded-4 shadow-sm">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div>
                                <h5 class="mb-1">{{ __('website.Ahmed Hassan') }}</h5>
                        ...
                        <p class="mb-0">{{ __('website.testimonial_islamic_studies_1') }}</p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="testimonial-card p-4 bg-white rounded-4 shadow-sm">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div>
                                <h5 class="mb-1">{{ __('website.Fatima Zahra') }}</h5>
                                <div class="text-warning">
                                    <i class="bi bi-star-fill"></i>
                                    <i class="bi bi-star-fill"></i>
                                    <i class="bi bi-star-fill"></i>
                        ...
                        <p class="mb-0">{{ __('website.testimonial_islamic_studies_2') }}</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="cta-section section py-5" style="background: linear-gradient(135deg, #ffffff 0%, #f8f9fa 100%);">
        <div class="container text-center text-dark">
            <h2 class="mb-4">{{ __('website.Ready to Deepen Your Islamic Knowledge?') }}</h2>
            <p class="lead mb-4">{{ __('website.Embark on a comprehensive journey through Islamic studies with qualified scholars and gain a deeper understanding of your faith.') }}</p>
